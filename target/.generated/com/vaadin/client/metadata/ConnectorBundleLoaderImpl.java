...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.Embedded","com.vaadin.ui.CustomField","com.vaadin.ui.CustomComponent","com.vaadin.ui.Audio","com.vaadin.ui.TextField","com.vaadin.ui.MenuBar","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.Video","com.vaadin.ui.OptionGroup","com.vaadin.ui.NativeSelect","com.vaadin.ui.VerticalLayout","com.vaadin.ui.NativeButton","com.vaadin.ui.PasswordField","com.vaadin.ui.JavaScript","com.vaadin.ui.CssLayout","com.vaadin.ui.ListSelect","com.vaadin.ui.FormLayout","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.CheckBox","com.vaadin.ui.Panel","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.DateField","com.vaadin.ui.Form","com.vaadin.ui.TabSheet","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.Window","com.vaadin.ui.ComboBox","com.vaadin.ui.PopupView","com.vaadin.ui.Table","com.vaadin.ui.UI","com.vaadin.ui.Slider","com.vaadin.ui.BrowserFrame","com.vaadin.ui.Image","com.vaadin.ui.Label","com.vaadin.ui.Upload","com.vaadin.ui.Flash","com.vaadin.ui.TreeTable","com.vaadin.ui.TwinColSelect","com.vaadin.ui.TextArea","com.vaadin.ui.CustomLayout","com.vaadin.ui.Accordion","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.Tree","com.vaadin.ui.Link","com.vaadin.server.FileDownloader","com.vaadin.ui.InlineDateField","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.GridLayout","com.vaadin.ui.Button","com.vaadin.server.AbstractJavaScriptExtension",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load1() {
            ...
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"id", "registeredEventListeners", "alternateText", "readOnly", "width", "primaryStyleName", "description", "styles", "height", "immediate", "caption", "resources", "enabled", "errorMessage", });
            ...
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"required", "height", "id", "propertyReadOnly", "registeredEventListeners", "maxLength", "errorMessage", "caption", "styles", "wordwrap", "tabIndex", "rows", "modified", "immediate", "text", "inputPrompt", "columns", "enabled", "hideErrors", "description", "readOnly", "width", "primaryStyleName", "resources", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"resources", "width", "height", "description", "primaryStyleName", "readOnly", "caption", "errorMessage", "disableOnClick", "id", "styles", "immediate", "registeredEventListeners", "tabIndex", "clickShortcutKeyCode", "htmlContentAllowed", "enabled", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"enabled", "hideErrors", "modified", "height", "description", "propertyReadOnly", "required", "styles", "caption", "registeredEventListeners", "id", "width", "errorMessage", "resources", "tabIndex", "primaryStyleName", "immediate", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"primaryStyleName", "errorMessage", "readOnly", "parameters", "registeredEventListeners", "height", "enabled", "features", "styles", "caption", "id", "uriFragment", "target", "immediate", "resources", "description", "width", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"height", "width", "enabled", "registeredEventListeners", "styles", "rpcInterfaces", "primaryStyleName", "callbackNames", "caption", "immediate", "id", "description", "resources", "readOnly", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"positionUnit", "minPositionUnit", "minPosition", "positionReversed", "maxPositionUnit", "locked", "maxPosition", "position", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"required", "readOnly", "description", "modified", "textFieldEnabled", "height", "enabled", "errorMessage", "tabIndex", "resources", "immediate", "styles", "caption", "registeredEventListeners", "width", "hideErrors", "propertyReadOnly", "primaryStyleName", "id", });
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"resources", "width", "alternateText", "description", "styles", "primaryStyleName", "registeredEventListeners", "height", "errorMessage", "enabled", "readOnly", "immediate", "id", "caption", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"enabled", "width", "showControls", "id", "registeredEventListeners", "errorMessage", "altText", "sourceTypes", "muted", "immediate", "autoplay", "caption", "readOnly", "resources", "styles", "description", "height", "sources", "primaryStyleName", "htmlContentAllowed", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"description", "errorMessage", "resources", "scrollLeft", "resizeLazy", "styles", "positionX", "caption", "enabled", "modal", "draggable", "width", "resizable", "positionY", "tabIndex", "readOnly", "centered", "registeredEventListeners", "primaryStyleName", "id", "immediate", "height", "scrollTop", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"propertyReadOnly", "description", "immediate", "styles", "resources", "tabIndex", "height", "width", "registeredEventListeners", "readOnly", "caption", "required", "modified", "errorMessage", "id", "hideErrors", "primaryStyleName", "enabled", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"orientation", "readOnly", "propertyReadOnly", "modified", "height", "caption", "description", "resolution", "errorMessage", "id", "maxValue", "hideErrors", "required", "registeredEventListeners", "minValue", "primaryStyleName", "value", "styles", "width", "resources", "enabled", "immediate", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"splitterState", "width", "caption", "id", "height", "registeredEventListeners", "primaryStyleName", "secondChild", "description", "readOnly", "styles", "enabled", "immediate", "firstChild", "resources", "errorMessage", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"enabled", "registeredEventListeners", "resources", "rpcInterfaces", "callbackNames", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"primaryStyleName", "modified", "width", "caption", "immediate", "styles", "resources", "propertyReadOnly", "height", "description", "required", "errorMessage", "id", "registeredEventListeners", "enabled", "readOnly", "hideErrors", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"readOnly", "modified", "height", "immediate", "id", "width", "styles", "resources", "enabled", "primaryStyleName", "propertyReadOnly", "tabIndex", "caption", "registeredEventListeners", "hideErrors", "description", "errorMessage", "required", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"alternateText", "id", "description", "enabled", "immediate", "height", "readOnly", "registeredEventListeners", "width", "caption", "styles", "errorMessage", "resources", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"primaryStyleName", "secondChild", "id", "styles", "errorMessage", "splitterState", "firstChild", "height", "registeredEventListeners", "width", "readOnly", "description", "caption", "enabled", "resources", "immediate", });
            ...
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"primaryStyleName", "resources", "hideErrors", "id", "registeredEventListeners", "height", "layout", "enabled", "width", "modified", "tabIndex", "caption", "required", "immediate", "description", "propertyReadOnly", "styles", "errorMessage", "readOnly", "footer", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"ctrlKey", "button", "clientY", "relativeY", "relativeX", "altKey", "clientX", "shiftKey", "metaKey", "type", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"registeredEventListeners", "spacing", "styles", "primaryStyleName", "errorMessage", "readOnly", "enabled", "description", "immediate", "caption", "width", "id", "height", "marginsBitmask", "resources", "childData", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"propertyReadOnly", "description", "checked", "resources", "required", "primaryStyleName", "id", "height", "errorMessage", "styles", "hideErrors", "width", "readOnly", "immediate", "modified", "enabled", "tabIndex", "caption", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"width", "primaryStyleName", "registeredEventListeners", "enabled", "readOnly", "styles", "childCss", "description", "caption", "height", "resources", "immediate", "errorMessage", "id", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"enabled", "readOnly", "errorMessage", "width", "height", "id", "immediate", "registeredEventListeners", "resources", "styles", "primaryStyleName", "description", "caption", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"spacing", "immediate", "errorMessage", "readOnly", "enabled", "resources", "registeredEventListeners", "width", "styles", "childData", "height", "description", "primaryStyleName", "id", "marginsBitmask", "caption", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"resources", "immediate", "readOnly", "description", "contentMode", "styles", "id", "text", "height", "width", "caption", "primaryStyleName", "errorMessage", "registeredEventListeners", "enabled", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"primaryStyleName", "errorMessage", "required", "resources", "immediate", "modified", "styles", "tabIndex", "pollingInterval", "readOnly", "indeterminate", "state", "id", "width", "propertyReadOnly", "hideErrors", "registeredEventListeners", "height", "caption", "enabled", "description", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"resources", "templateName", "primaryStyleName", "description", "caption", "height", "errorMessage", "readOnly", "id", "registeredEventListeners", "enabled", "styles", "width", "childLocations", "immediate", "templateContents", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.ChildComponentData.class, new String[] {"row1", "column1", "row2", "alignment", "column2", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"height", "errorMessage", "description", "id", "width", "registeredEventListeners", "caption", "enabled", "primaryStyleName", "modified", "hideErrors", "resources", "immediate", "propertyReadOnly", "required", "styles", "tabIndex", "readOnly", });
            load2();
          }
          private void load2() {
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"height", "resources", "id", "registeredEventListeners", "errorMessage", "width", "enabled", "primaryStyleName", "caption", "readOnly", "description", "immediate", "styles", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"immediate", "tabIndex", "id", "width", "resources", "registeredEventListeners", "scrollTop", "primaryStyleName", "description", "caption", "height", "enabled", "errorMessage", "scrollLeft", "styles", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"width", "id", "errorMessage", "styles", "childData", "resources", "height", "immediate", "readOnly", "caption", "primaryStyleName", "registeredEventListeners", "enabled", "marginsBitmask", "description", "spacing", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"width", "height", "styles", "resources", "errorMessage", "description", "immediate", "primaryStyleName", "id", "readOnly", "registeredEventListeners", "caption", "enabled", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"primaryStyleName", "enabled", "htmlContentAllowed", "width", "registeredEventListeners", "immediate", "id", "caption", "resources", "styles", "height", "errorMessage", "showControls", "autoplay", "sourceTypes", "readOnly", "description", "sources", "altText", "muted", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"primaryStyleName", "enabled", "connectorToCssPosition", "id", "registeredEventListeners", "height", "errorMessage", "readOnly", "width", "description", "styles", "immediate", "resources", "caption", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"errorMessage", "tabIndex", "readOnly", "styles", "id", "description", "htmlContentAllowed", "clickShortcutKeyCode", "registeredEventListeners", "height", "width", "primaryStyleName", "disableOnClick", "resources", "caption", "enabled", "immediate", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"required", "description", "modified", "caption", "width", "immediate", "styles", "registeredEventListeners", "propertyReadOnly", "height", "readOnly", "hideErrors", "enabled", "id", "errorMessage", "primaryStyleName", "resources", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"description", "rows", "id", "immediate", "readOnly", "registeredEventListeners", "childData", "resources", "primaryStyleName", "spacing", "marginsBitmask", "caption", "errorMessage", "columns", "height", "styles", "width", "enabled", });
            store.setProperties(com.vaadin.shared.extension.javascriptmanager.JavaScriptManagerState.class, new String[] {"enabled", "resources", "registeredEventListeners", "names", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"width", "errorMessage", "codetype", "height", "archive", "standby", "description", "registeredEventListeners", "readOnly", "primaryStyleName", "resources", "id", "caption", "enabled", "codebase", "classId", "styles", "embedParams", "alternateText", "immediate", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"enabled", "id", "immediate", "description", "primaryStyleName", "errorMessage", "height", "caption", "required", "width", "readOnly", "hideErrors", "tabIndex", "resources", "modified", "propertyReadOnly", "registeredEventListeners", "styles", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"registeredEventListeners", "styles", "primaryStyleName", "tabIndex", "height", "width", "readOnly", "description", "enabled", "resources", "id", "errorMessage", "caption", "immediate", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"registeredEventListeners", "id", "modified", "styles", "enabled", "resources", "immediate", "primaryStyleName", "width", "tabIndex", "readOnly", "caption", "hideErrors", "required", "errorMessage", "propertyReadOnly", "description", "height", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"description", "enabled", "caption", "styles", "primaryStyleName", "registeredEventListeners", "immediate", "errorMessage", "id", "resources", "width", "readOnly", "height", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"height", "resources", "primaryStyleName", "id", "html", "hideOnMouseOut", "width", "description", "styles", "immediate", "enabled", "caption", "registeredEventListeners", "errorMessage", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"id", "columns", "text", "description", "caption", "primaryStyleName", "propertyReadOnly", "styles", "tabIndex", "immediate", "errorMessage", "readOnly", "registeredEventListeners", "hideErrors", "maxLength", "modified", "resources", "height", "inputPrompt", "width", "enabled", "required", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"description", "height", "bgColor", "caption", "immediate", "width", "styles", "primaryStyleName", "id", "registeredEventListeners", "errorMessage", "readOnly", "cursorY", "cursorX", "enabled", "resources", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"errorMessage", "registeredEventListeners", "description", "enabled", "color", "styles", "height", "immediate", "id", "primaryStyleName", "htmlContentAllowed", "caption", "popupVisible", "resources", "showDefaultCaption", "readOnly", "width", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"enabled", "description", "width", "primaryStyleName", "immediate", "changedColor", "registeredEventListeners", "rowCount", "styles", "readOnly", "resources", "height", "changedX", "changedY", "caption", "errorMessage", "columnCount", "id", });
